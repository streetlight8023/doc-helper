...
public class ViewController extends BaseController {
    ...
    @GetMapping(FebsConstant.VIEW_PREFIX + "doc/advice")
    public String adviceIndex() {
        return FebsUtil.view("doc/advice/index");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "doc/prescription")
    public String prescriptionIndex() {
        return FebsUtil.view("doc/prescription/index");
    }

    @GetMapping(FebsConstant.VIEW_PREFIX + "doc/advice/toadd/{stackId}")
    public String toAddAdvice(@PathVariable String stackId, Model model) {
        model.addAttribute("stackId", stackId);
        return FebsUtil.view("doc/advice/drugAdd");
    }
    ...
    private void resolveDrugModel(String stackId, Model model) {
        model.addAttribute("stackId", stackId);
    }
}
